...
def run_vgg16(dir_Flickr_jpg):
    ...
    for i,name in enumerate(jpgs):
        ...
        dump(images, open('C:/Users/Xpro/Flickr30k/testimage/images.pkl', 'wb'))
...
def main():
    dir_Flickr_jpg = r"C:/Users/Xpro/Flickr30k/flickr30k_images/flickr30k_images/"
    run_vgg16(dir_Flickr_jpg)
    images = pd.read_pickle('C:/Users/Xpro/Flickr30k/data/images.pkl', compression='infer')
    df_txt0 = pd.read_csv('C:/Users/Xpro/Flickr30k/data/token0.txt', sep='\t')
